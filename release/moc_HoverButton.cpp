...
#include "../../FlashQuiz/HoverButton.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_HoverButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HoverButton_t qt_meta_stringdata_HoverButton = {
    {
QT_MOC_LITERAL(0, 0, 11) // "HoverButton"
...
QT_INIT_METAOBJECT const QMetaObject HoverButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_HoverButton.data,
      qt_meta_data_HoverButton,  qt_static_metacall, nullptr, nullptr}
};
...
void *HoverButton::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HoverButton.stringdata0))
